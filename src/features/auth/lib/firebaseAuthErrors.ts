...
const commonAuthCodeToKey: Record<string, ErrorKey> = {
...
const googlePopupCodeToKey: Record<string, ErrorKey> = {
...
export function mapFirebaseAuthError(
  e: unknown,
  t: TFunction,
  extraCodeToKey: Record<string, ErrorKey> = {},
  fallbackKey: ErrorKey = "auth.errors.generic",
): string {
